  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        ...
        <p>lab Equipment.</p>
        <p>Basic Laboratory Instruments</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
              <div class="services-list">
                <a href="#" class="service-link active" data-target="pax">Sample Preparation & Handling</a>
                <a href="#" class="service-link" data-target="nahs">Safety & Laboratory Consumables</a>
                <a href="#" class="service-link" data-target="balls">Analytical Instruments</a>
                <a href="#" class="service-link" data-target="flocculants">Water & Environmental Testing</a>
